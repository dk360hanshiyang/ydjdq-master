...
import com.sudaizhijia.ydjdq.utils.DeviceUtils;
...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        underLine.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dpTpPx(0.3f)));
...
//        tab.setPadding(dpTpPx(5), dpTpPx(12), dpTpPx(0.1f), dpTpPx(12));
        tab.setPadding(dpTpPx(55), dpTpPx(12), dpTpPx(70), dpTpPx(12));
        //添加点击事件
...
//        linearLayout.addView(imageView);
        ...
        if (i < tabTexts.size() - 1) {
            ...
            layoutParams.topMargin = dpTpPx(13f);
            layoutParams.bottomMargin = dpTpPx(13f);
            layoutParams.leftMargin = dpTpPx(-24f);
