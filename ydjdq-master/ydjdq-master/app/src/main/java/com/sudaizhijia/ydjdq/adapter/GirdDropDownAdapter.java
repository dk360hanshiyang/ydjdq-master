    ...
    private void fillValue(int position, ViewHolder viewHolder) {
        ...
        if (checkItemPosition != -1) {
            if (checkItemPosition == position) {
                viewHolder.mText.setTextColor(context.getResources().getColor(R.color.tv_tab_press));
                ...
                viewHolder.mText.setTextColor(context.getResources().getColor(R.color.operation_tvcolor));
